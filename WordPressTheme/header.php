...
<div class="p-header__right">
  <ul class="p-header__nav-wrap">
    <li class="p-header__nav">
      <a class="p-header__nav-link <?php check('home')?>" href="<?php echo $home?>">
    ...
    <li class="p-header__nav">
      <a class="p-header__nav-link <?php check('about')?>" href="<?php echo $about?>">
    ...
    <li class="p-header__nav">
      <a class="p-header__nav-link <?php check('medical')?>" href="<?php echo $medical?>">
    ...
    <li class="p-header__nav">
      <a class="p-header__nav-link <?php check('staff')?>" href="<?php echo $staff?>">
    ...
    <li class="p-header__nav">
      <a class="p-header__nav-link <?php check('blog')?>" href="<?php echo $blog?>">
    ...
    <li class="p-header__nav">
      <a class="p-header__nav-link <?php check('contact')?>" href="<?php echo $contact?>">
